...
const Data = () => {
  return (
    <div className="home__data">
        ...
        <p className="home__description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Cum rem consequatur eaque voluptatum ipsam in quo fuga alias, provident quod amet eius voluptas facilis saepe labore id maxime vitae deleniti.</p>
